...
/**
 * Instrucciones:
 * 11.- Cambiamos el namespace del archivo
 *          namespace Contpaqi.Sdk
 *      a
 *          namespace DocEntradaAlmacen.Comercial
 *          *   Nota: el Nombre depende de como se llame el proyecto
 *          *   Hasta el momento no deben aparecer errores en el proyecto
 * 12.- Nos digirmos al siguiente archivo Form1.cs en modo de codigo
 *      12.01.- Unicamos el archivo y dar clic derecho
 *      12.02.- Seleccionamos la opcion Ver código.
 */
namespace ConectorComercialCLI.Comercial
{
