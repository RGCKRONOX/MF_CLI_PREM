...
/**
 * Instrucciones:
 * 07.- Cambiamos el namespace del archivo
 *          namespace Contpaqi.Sdk
 *      a
 *          namespace DocEntradaAlmacen.Comercial
 *          *   Nota: el Nombre depende de como se llame el proyecto
 *          *   Hasta el momento ignoramos los errores
 * 08.- Nos digirmos al siguiente archivo Constantes.cs
 */
namespace ConectorComercialCLI.Comercial
{
    public static class ComercialSdk_
    {
